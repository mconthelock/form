...
class cn_model extends my_model 
{
    ...
    {
        $this->db
        ->select('Q.* , TO_CHAR(Q.SUBMITDATE,\'DD/MM/YYYY\') as SSUBMITDATE , TO_CHAR(Q.INSPECDATE,\'DD/MM/YYYY\') as SINSPECDATE , TO_CHAR(Q.EXPCHGDATE,\'DD/MM/YYYY\') as SEXPCHGDATE , TO_CHAR(F.DREQDATE,\'DD/MM/YYYY\') as SREQDATE , CLS.CLSCHANGE , RS.REASON , JUD.JUDGEMENT, F.VREQNO , R.SNAME as REQNAME , F.VINPUTER , I.SNAME as INPNAME , F.CST')
        ->from('CNFORM Q')
