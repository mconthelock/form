    ...
    public function action()
    {
        ...
        try{
            ...
            }else if($act == "return")
            {
                ...
                $this->cn->execsql($sqlOra);
                $sqlOra = "update flow set CSTEPST = '2' , VREMARK = '".$_POST['txtRemark']."' where NFRMNO = '".$nfrmno."' AND VORGNO = '".$vorgno."' and CYEAR = '".$cyear."' and CYEAR2 = '".$cyear2."' and NRUNNO = '".$nrunno."' and CSTEPST = '3'";
                $this->cn->execsql($sqlOra);
