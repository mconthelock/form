...
@section('contents')
    <div
        ...
        <form class="max-w-212 w-full bg-base-100 p-8 shadow-2xl rounded-2xl border border-base-200" id="rbForm"
            ...
            <div class="border border-base-300 flex flex-col mb-6 rounded-lg overflow-hidden shadow-sm">
                ...
                <div class="flex bg-base-50/50">
                    <div class="w-1/2 border-r border-base-300 p-2 flex items-center gap-2">
                        ...
                        <input type="text"
                            class="input input-sm input-ghost w-full rounded-none border-b border-base-300 focus:border-primary focus:bg-base-200/50 px-1 req"
                            id="empDept" name="empDept" readonly>
                    </div>
                    <div class="w-1/2 p-2 flex items-center gap-2">
                        <span class="whitespace-nowrap font-semibold opacity-80 text-xs">ตำแหน่ง/Position:</span>
                        <input type="text"
                            class="input input-sm input-ghost w-full rounded-none border-b border-base-300 focus:border-primary focus:bg-base-200/50 px-1 req"
                            id="empPos" name="empPos" readonly>
                        <input type="hidden" name="SPOSCODE" id="empPosCode">
                    </div>
                </div>
            </div>

            <div class="font-bold text-primary mb-5 mt-8 text-sm flex items-center gap-2">
                <input type="radio" id="radioStandard" name="REQ_TYPE" value="1"
                    class="radio radio-primary radio-sm stampFormatGroup" checked>
                            ...
                            <tr class="transition-opacity duration-300" id="rowStamp1">
                                ...
                                <td class="border-b border-base-300 p-3 align-top">
                                    <div class="text-error/80 font-medium mb-2">โปรดระบุชื่อของผู้ใช้งาน
                                        ...
                                        <span class="text-base-content/70 font-normal italic">Identify name in
                                            English:</span>
                                    </div>
            ...
            <div class="font-bold text-sm flex items-center gap-2 mb-5">
                <input type="radio" id="radioOther" name="REQ_TYPE" value="2"
                    class="radio radio-primary radio-sm stampFormatGroup">
            ...
            <div class="border border-base-300 p-4 rounded-lg bg-base-200/30 transition-opacity duration-300"
                ...
                <fieldset class="fieldset">
                    <legend class="fieldset-legend text-sm">โปรดระบุเหตุผลในการใช้งาน / Please identify the reason for
                        using*
                    </legend>
                    <textarea class="textarea h-24 w-full req" id="otherReason" name="PURPOSE_OTHER" placeholder="Reason"></textarea>
                    <input type="hidden" name="PURPOSE_ID" id="otherPurposeId">
                </fieldset>
                <div class="flex gap-4 mt-6">
                    <label for="otherQty" class="fieldset-legend whitespace-nowrap w-32">จำนวน/Qty:</label>
                    <input type="number"
                        class="input input-sm input-ghost w-24 rounded-none border-b border-base-300 focus:border-primary px-1 text-center req"
                        id="otherQty" name="REQ_QTY" value="1">
                </div>
                <div class="flex gap-4 mt-6">
                    <label for="otherQty" class="fieldset-legend whitespace-nowrap w-32">แนบไฟล์/Attach file:</label>
                    <input type="file" class="file-input file-input-bordered file-input-sm req" id="otherAttachment"
                        name="otherAttachment" accept=".pdf,.xlsx,.docx,image/*">
                </div>
            </div>
