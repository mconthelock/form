<div class="max-w-5xl mx-auto bg-white p-8 mt-8 rounded-xl shadow-lg">
    ...
    <div class="mb-6" id="meth_part5">
        ...
        <div id="methReasonBox" class="ml-6 hidden">
            ...
            <label class="block mb-2">
                <input type="radio" name="methReason" value="other" class="mr-2"> เหตุผลอื่น:
                <input type="text" id="methReasonText" class="input input-bordered ml-2 w-1/2" maxlength="200"
