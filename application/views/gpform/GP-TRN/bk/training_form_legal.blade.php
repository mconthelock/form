<style>
    ...
    /* สำหรับ input / textarea ที่มี data-alert (ถือว่าต้องกรอก) */
    input[data-alert]:not([type="radio"]):not([type="checkbox"]),
    textarea[data-alert],
    select[data-alert] {
        border-color: #f87171 !important; /* สีแดงอ่อน */
    }
</style>
<div class="max-w-5xl mx-auto bg-white p-8 mt-8 rounded-xl shadow-lg">
    ...
    <div class="mb-6" id="legal_part1">
        ...
        <input type="text" id="legalLocation" placeholder="1.3 สถานที่"
            class="input input-bordered w-full mb-2 required" maxlength="200"
    ...
    <div class="mb-6" id="legal_part2">
        ...
        <textarea id="legalConcernLaw" class="textarea textarea-bordered w-full required" rows="3" maxlength="200"
    ...
    <div class="mb-6" id="legal_part6">
        ...
        <div id="legalReasonBox" class="ml-6 hidden">
            ...
            <label class="block mb-2">
                ...
                <input type="text" id="legalReasonText" class="input input-bordered ml-2 w-1/2" maxlength="200"
    ...
    <div class="mb-6" id="legal_part7">
        ...
        <div class="flex items-center gap-3 mb-2">
            <input type="number" id="legalAmountInput" name="legalAmountInput" placeholder="จำนวนเงิน (บาท)" min="0"
