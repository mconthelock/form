<div class="max-w-5xl mx-auto bg-white p-8 mt-8 rounded-xl shadow-lg">
    ...
    <div class="flex items-center gap-8 mb-4">
        ...
        <div class="flex items-center gap-2">
            <label for="posRequestBy" class="text-sm font-bold text-gray-700 whitespace-nowrap">
                Request By
            </label>
            <input type="text" id="posRequestBy" name="posRequestBy"
                class="input input-bordered w-24 text-center"
                placeholder="รหัสพนักงาน" maxlength="5"
                data-alert="กรุณากรอก Request By (รหัสพนักงาน) !!">
            <span id="posRequestByName" class="font-semibold text-blue-600"></span>
        </div>
    </div>
    ...
    <div class="mb-6" id="pos_part5">
        ...
        <label class="block mb-2">
            <input type="radio" name="posExpenseOption" value="not_compare" class="mr-2">
            ไม่มีการเปรียบเทียบราคา
        </label>
        <div id="posReasonBox" class="ml-6 hidden">
            <label class="block mb-2">
                <input type="radio" name="posReason" value="free" class="mr-2">
                อบรมฟรี
            </label>
            <label class="block mb-2">
                <input type="radio" name="posReason" value="other" class="mr-2"> เหตุผลอื่น:
                <input type="text" id="posReasonText" class="input input-bordered ml-2 w-1/2" maxlength="200"
                    data-alert="กรุณาระบุเหตุผลอื่น">
            </label>
        </div>
        <label class="block mt-4">
            <input type="radio" name="posExpenseOption" value="compare" class="mr-2">
