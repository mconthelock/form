        ...
        <?if($data_head[0]->FID == '1'){?>
                    ...
                    <tr>
                        ...
                        <td class="p-3 text-blue-600 font-semibold">
                            @foreach($data_attach_jd as $row_jd)
                                <a href="{{ base_url('gpform/GP-TRN/training/preview_file/' . $row_jd->FILENAME) }}" target="_blank" class="text-blue-700 underline btn btn-sm rounded-lg">
                                        {{ $row_jd->FILENAME }}
                                </a>
                            @endforeach
                        </td>
            ...
            @if ($mode == '02')
                <div class="mb-4 mt-6">
                    ...
                    <textarea name="REMARK" class="w-full border p-2 rounded mb-3" placeholder="หมายเหตุ"></textarea>
                </div>

                <div class="flex justify-center gap-12">
                    <button type="submit" name="ACTION" value="approve" 
                        class="px-6 py-3 bg-blue-600 text-white rounded-lg shadow cursor-pointer hover:bg-blue-700">
                        ✅ Approve
                    </button>
                    <button type="submit" name="ACTION" value="reject" 
                        class="px-6 py-3 bg-red-600 text-white rounded-lg shadow cursor-pointer hover:bg-red-700">
                        ❌ Reject
                    </button>
                    <button type="submit" name="ACTION" value="return" 
                        class="px-6 py-3 bg-yellow-500 text-white rounded-lg shadow cursor-pointer hover:bg-yellow-600">
                        ↩ Return
                    </button>
                </div>
            @endif
