<div class="max-w-5xl mx-auto bg-white p-8 mt-8 rounded-xl shadow-lg">
    <h2 class="text-2xl font-bold mb-6 text-center text-gray-800">
        ...
        สนับสนุน ความรู้ / ทักษะ / คุณลักษณะ เฉพาะสายงาน (Support Specific Functional Competency)
    </h2>
    ...
    <div class="mb-6" id="func_part1">
        ...
        <div class="flex gap-2 mb-2 items-center">
            ...
            <input type="date" id="funcDateFrom" class="input input-bordered w-[200px]" data-alert="กรุณาเลือกวันที่อบรม" maxlength="8">
            <span class="self-center">ถึง</span>
            <input type="date" id="funcDateTo" class="input input-bordered w-[200px]" data-alert="กรุณาเลือกวันที่อบรม" maxlength="8">
        ...
        <input type="text" id="funcLocation"
            placeholder="1.3 สถานที่" maxlength="200"
            class="input input-bordered w-full mb-2"
            data-alert="กรุณาระบุสถานที่">
        <input type="text" id="funcInstitute"
            placeholder="1.4 สถาบันฝึกอบรม" maxlength="200"
    ...
    <div class="mb-6" id="func_part4">
        ...
        <div class="grid grid-cols-2 gap-4 mb-1">
            <input type="text" id="funcTraineeCode" 
                ...
                <input type="hidden" name="funcTraineeposcode" value="">
        </div>
        <div class="grid grid-cols-2 gap-4 mb-1">
        ...
        <input type="text" id="funcJdName"
            placeholder="ชื่องานตาม Job Description" maxlength="100"
            class="input input-bordered w-full mb-1 font-bold"
            data-alert="กรุณากรอก Job Description">
            <div class="flex items-center gap-3 mb-3">
                <label for="funcOtherFiles" class="font-semibold text-gray-700 whitespace-nowrap">
                แนบเอกสาร JD:
                </label>
    ...
    <div class="mb-6" id="func_part5">
        ...
        <div id="funcReasonBox" class="ml-6 hidden">
            <label class="block mb-2">
                <input type="radio" name="funcReason" value="1" class="mr-2">
                อบรมฟรี (Free of Charge)
            </label>
            <label class="block mb-2">
                <input type="radio" name="funcReason" value="0" class="mr-2">
                เหตุผลอื่น:
                <input type="text" id="funcReasonOtherText"
                    class="input input-bordered w-full"
                    placeholder="โปรดระบุเหตุผล" maxlength="200"
                    data-alert="กรุณาระบุเหตุผลอื่น">
            </label>
        </div>
        <label class="block mt-4">
            <input type="radio" name="funcExpenseOption" value="1" class="mr-2">
    ...
    <div id="func_part6" class="mb-6">
        ...
        <textarea id="funcAmountNote" class="textarea textarea-bordered w-full" maxlength="200" rows="2" placeholder="บันทึกเพิ่มเติม..."></textarea>
    </div>
    ...
    <div class="mb-6" id="func_part7">
        ...
        <div class="p-3 rounded-lg border border-red-300 bg-red-50 text-red-700 text-xs leading-relaxed">
            <p>
                <b>7.1)</b> <font>ภายหลังเอกสารนี้ ได้รับอนุมัติจาก RAF Div. แล้ว ผู้เข้ารับการฝึกอบรม หรือ หน่วยงานต้นสังกัด จะต้องเป็นผู้ขออนุญาตใช้รถบริษัทฯ เพื่อการเดินทาง</font><br>
                <font>(After approved by RAF Div., Participant or Direct Section have responsible for request company car for traveling) </font><br>
                <b>***</b><br>
                <font>1.ในกรณีที่ต้องการยกเลิกการอบรมให้ติดต่อแผนกพัฒนาทรัพยากรมนุษย์ก่อนถึงวันอบรม 7 วันทำการ โดยยึดตามระเบียบ RAF-PR-T002</font><br>
                <font>2.ในกรณีที่บริษัทฯ ไม่สามารถจัดรถรับ-ส่ง ได้ ให้พนักงานติดต่อแผนกธุรการและทำตามขั้นตอนการเบิกจ่ายสำหรับการเดินทาง</font>
            </p>
        </div>
    </div>
