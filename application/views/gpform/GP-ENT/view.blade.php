    ...
    <div class="w-full min-h-screen bg-gray-100 px-2 pb-10">
        <div class="max-w-5xl mx-auto bg-white rounded-2xl shadow p-10 border-2 border-gray-300">
                        ...
                        <tbody>
                            ...
                            @if ($dataForm->FILE_MEMO_GIFT)
                                <tr>
                                    ...
                                    <td class="py-2 pl-4 border-b-2 border-blue-200">
                                        <a href="{{ base_url('gpform/GP-ENT/main/preview/' . $dataForm->FILE_MEMO_GIFT) }}" target="_blank" class="text-blue-700 underline btn btn-sm rounded-lg">
                            ...
                            @if ($dataForm->FILE_MEMO_OTHER)
                                <tr>
                                    ...
                                    <td class="py-2 pl-4 border-b-2 border-blue-200">
                                        <a href="{{ base_url('gpform/GP-ENT/main/preview/' . $dataForm->FILE_MEMO_OTHER) }}" target="_blank" class="text-blue-700 underline btn btn-sm rounded-lg">
            ...
            @if ($mode == '02')
                ...
                @endphp
                @if (in_array($flowstep[0]->CSTEPNO, ['19', '34']) && $flowstep[0]->CSTEPNEXTNO == '13' && isset($PRESIDENT->VEMPNO) && isset($RAF->VEMPNO) && in_array($PRESIDENT->VEMPNO, $amecIds))
