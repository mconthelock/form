      ...
      + Add Row
        ...
        <tr>
            ...
            <td class="px-3 py-1 bg-gray-100 text-gray-800 border-b border-white">
                        ...
                        <label class="flex items-center gap-1">
                            <input type="radio" name="radsec" class="h-4 w-4" value="1">
                            <span>Yes</span>
                        </label>

                        <label class="flex items-center gap-1">
                            <input type="radio" name="radsec" class="h-4 w-4" value="2">
                            <span>No</span>
                        </label>
                        </div>
            </td>
        ...
        <tr id="proc" style="">
            ...
            <td class="px-3 py-1 bg-gray-100 text-gray-800 border-b border-white">
                        ...
                        <div class="flex items-center gap-4">
                        <label class="flex items-center gap-1">
                            <input type="radio"  name="radProcAMEC"  class="h-4 w-4" value="1">
                            <span>Yes</span>
                        </label>
                        <label class="flex items-center gap-1">
                            <input type="radio"  name="radProcAMEC"   class="h-4 w-4" value="2">
                            <span>No</span>
                        </label>
                        </div>
            </td>
      ...
      <tr id="eval" style="">
            ...
            <td class="px-3 py-1 bg-gray-100 text-gray-800 border-b border-white">
                ...
                @foreach ($cncls as $c)
                     <label class="flex items-center space-x-2 cursor-pointer">
                        <input type="radio" name="chkClass" class="h-4 w-4" value="{{ $c->CLSNO }}"   >
        ...
        <tr>
            ...
            <td class="px-3 py-1 bg-gray-100 text-gray-800 border-b border-white">
                    ...
                    <label class="flex items-center space-x-2 cursor-pointer">
                        <input type="radio" name="radReason" class="h-4 w-4" value="{{ $r->RSNNO}}" >
        ...
        <tr>
            ...
            <td class="px-3 py-1 bg-gray-100 text-gray-800 border-b border-white">
                <div class="flex flex-col space-y-1">
                    <label class="flex items-center space-x-2 cursor-pointer">
                        <input type="radio" name="radSample" class="h-4 w-4" value="1"   >
                        <span>Scrap</span>
                    </label>
                    <label class="flex items-center space-x-2 cursor-pointer">
                        <input type="radio" name="radSample" class="h-4 w-4" value="2"   >
                        <span class="w-20">Return to</span><span class="px-2 w-1/3"> <input type="text" name="txtReturn" 
                    ...
                    <label class="flex items-center space-x-2 cursor-pointer">
                        ...
                        <span class="w-20">Other</span><span class="px-2 w-1/3"> <input type="text" name="txtOth" 
                       class="w-full h-8 px-2 border border-gray-300 bg-white focus:outline-none focus:ring-1 focus:ring-sky-400 rounded-sm"
                       value="" ></span>
                    </label>
                </div>
