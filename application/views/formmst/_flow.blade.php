<ul class="list bg-base-100 rounded-box shadow-md border border-slate-200">
    <li class="p-4 pb-2 text-xs tracking-wide flex">
        ...
        <a href="#" class="btn btn-primary" id="add-flow">+</a>
    </li>
...
<div class="flex flex-col">
    <fieldset class="fieldset">
        <legend class="fieldset-legend">Step No.</legend>
        <input type="text" class="input" placeholder="Type here" />
    </fieldset>

    <fieldset class="fieldset">
        <legend class="fieldset-legend">Step Next to.</legend>
        <input type="text" class="input" placeholder="Type here" />
    </fieldset>

    <fieldset class="fieldset">
        <legend class="fieldset-legend">Position No</legend>
        <input type="text" class="input" placeholder="Type here" />
    </fieldset>

    <fieldset class="fieldset">
        <legend class="fieldset-legend">Approve No</legend>
        <input type="text" class="input" placeholder="Type here" />
    </fieldset>

    <fieldset class="fieldset">
        <legend class="fieldset-legend">Approve Org.</legend>
        <input type="text" class="input" placeholder="Type here" />
    </fieldset>
</div>
