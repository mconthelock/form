...
<section class="mb-12">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
    ...
    <div>
      ...
      <input type="text" name="salecom" id="salecom" value="{{ ($mode == '2' && !empty($visit)) ? $visit[0]->SALECOM  : '' }}" class="datesel input input-bordered rounded-xl  w-72 shadow-sm border-blue-200 text-gray-900">
      <!-- <select
        id="salecom"
        name="salecom"
