        ...
        <div class="card-body p-6 lg:p-10">
            ...
            <form id="form" class="flex flex-col gap-5">
                ...
                <section id="section-5">
                    ...
                    <div class="flex gap-8 justify-between">
                        <fieldset class="flex-col gap-4">
                            {{-- <label>
                                <input type="radio" name="PAYMENT_TYPE" value="First payment condition (If any)" p-type="first" class="radio radio-xs req">
                                First payment condition (If any)
                            </label>
                            <label>
                                <input type="radio" name="PAYMENT_TYPE" value="Second payment condition or" p-type="second" class="radio radio-xs req">
                                Second payment condition or
                            </label> --}}
                            <label>
                ...
                <section>
                    ...
                    {{-- <fieldset class="guide-line-attach flex-col">
                        <ul id="guide-first" class="hidden">
                            <li>P/O Confirmation</li>
                        </ul>
                        <ul id="guide-second" class="hidden">
                            <li>Equipment Evaluation Report</li>
                            <li>
                                3
                                <sup>rd</sup> Party Confirmation
                            </li>
                            <li>Delivery Confirmation</li>
                        </ul>
                        <ul id="guide-final" class="hidden">
                            <li>Part Evaluation /Audit Report</li>
                            <li>
                                3
                                <sup>rd</sup> Party Confirmation
                            </li>
                            <li>Delivery Confirmation</li>
                            <li>"Asset use Agreement" or "Request Equipment to Outside" Sheet.(for Outside Asset)</li>
                        </ul>
                    </fieldset> --}}
