...
class TCPDF {
	...
	public function write2DBarcode($code, $type, $x=null, $y=null, $w=null, $h=null, $style=array(), $align='', $distort=false) {
		...
		$hpad = is_numeric($style['hpadding']) ? (2 * $style['hpadding']) : 0;
        $vpad = is_numeric($style['vpadding']) ? (2 * $style['vpadding']) : 0;
		...
		$xstart = $xpos + ((is_numeric($style['hpadding']) ?  $style['hpadding'] : 0) * $cw);
		$ystart = $y + ((is_numeric($style['vpadding']) ?  $style['vpadding'] : 0) * $ch);
