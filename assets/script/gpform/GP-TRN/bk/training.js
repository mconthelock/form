...
const form_js_1 = require("@amec/webasset/form");
const _form_js_1 = require("@amec/webasset/form");
// ✅ Loader helper
function showLoader() {
	var _a;
	(_a = document.getElementById("loaderOverlay")) === null || _a === void 0
		? void 0
...
function buildFormDataGeneric(headResult, fid, prefix) {
	...
	const getVal = (id, def = "") => {
		var _a;
		return (
			((_a = document.getElementById(`${prefix}${id}`)) === null ||
			_a === void 0
				? void 0
				: _a.value) || def
		);
	...
	const expenseOption =
		((_a = document.querySelector(
			`input[name='${prefix}ExpenseOption']:checked`
		)) === null || _a === void 0
			? void 0
			: _a.value) || "";
	...
	const reason =
		((_b = document.querySelector(
			`input[name='${prefix}Reason']:checked`
		)) === null || _b === void 0
			? void 0
			: _b.value) || "";
	...
	const compareFiles =
		(_c = document.getElementById(`${prefix}CompareFiles`)) === null ||
		_c === void 0
			? void 0
			: _c.files;
	if (compareFiles) {
	...
	switch (prefix) {
		case "func":
			...
			const jdFiles =
				(_d = document.getElementById(`${prefix}JdFiles`)) === null ||
				_d === void 0
					? void 0
					: _d.files;
			if (jdFiles) {
...
document.addEventListener("DOMContentLoaded", () => {
	...
	(0, initForms_js_1.initBackButtons)(
		trainingType,
		selectCard,
		requestForm,
		detailBox
	...
	trainingType === null || trainingType === void 0
		? void 0
		: trainingType.addEventListener("change", () => {
				...
				if (details[val]) {
					...
					detailBox === null || detailBox === void 0
						? void 0
		...
		: submitBtn.addEventListener("click", () => {
				const val =
					trainingType === null || trainingType === void 0
						...
						: trainingType.value;
				if (!val) {
					(0, alert_js_1.showAlert)(
						"⚠ แจ้งเตือน",
						"กรุณาเลือกประเภทการฝึกอบรมก่อน !!"
					);
					return;
				}
				// ซ่อน card เลือก
				selectCard === null || selectCard === void 0
					? void 0
					: selectCard.classList.add("hidden");
				document
					.querySelectorAll("#requestForm > div")
					.forEach((div) => {
						div.classList.add("hidden");
					});
				const selectedForm = document.getElementById("form_" + val);
				if (selectedForm) {
					requestForm === null || requestForm === void 0
						? void 0
						: requestForm.classList.remove("hidden");
					selectedForm.classList.remove("hidden");
					if (val === "functional")
						(0, initForms_js_1.initFunctionalForm)();
					if (val === "legal") (0, initForms_js_1.initLegalForm)();
					if (val === "meth") (0, initForms_js_1.initMethForm)();
				}
		  });
	...
	async function submitForm(formType, reqby, inputby, fid) {
		...
		try {
			...
			const nfrmno =
				((_b =
					(_a = document.getElementById("NFRMNO")) === null ||
					_a === void 0
						? void 0
			...
			const vorgno =
				((_d =
					(_c = document.getElementById("VORGNO")) === null ||
					_c === void 0
						? void 0
			...
			const cyear =
				((_f =
					(_e = document.getElementById("CYEAR")) === null ||
					_e === void 0
						? void 0
			...
			if (
				...
				!vorgno ||
				!cyear ||
				!(reqby === null || reqby === void 0 ? void 0 : reqby.trim()) ||
				!(inputby === null || inputby === void 0
					? void 0
					: inputby.trim())
			) {
				hideLoader();
				(0, alert_js_1.showAlert)(
					"⚠ แจ้งเตือน",
					"ข้อมูลไม่ครบถ้วน (NFRMNO, VORGNO, CYEAR, Request By, Input By)"
				);
				return;
			}
			const formDatakey = {
			...
			const formData = buildFormDataGeneric(
				headResult,
				fid,
				formType === "functional" ? "func" : formType
			);
			...
			if (saveResult.status !== "success") {
				(0, alert_js_1.showAlert)(
					"❌ ล้มเหลว",
					saveResult.message || "ไม่สามารถบันทึกข้อมูลได้"
				);
				return;
			}
			(0, alert_js_1.showAlert)(
				"✅ สำเร็จ",
				`ฟอร์ม ${formType} ส่งเรียบร้อยแล้ว`
			);
	...
	async function handleFormSubmit(formType) {
		...
		if (formType === "functional") {
			...
			reqby =
				((_a = document.getElementById("funcRequestBy")) === null ||
				_a === void 0
					? void 0
					: _a.value) || "";
			inputby =
				((_b = document.getElementById("funcInputBy")) === null ||
				_b === void 0
					? void 0
					: _b.value) || "";
			fid = "1";
			...
			reqby =
				((_c = document.getElementById("legalRequestBy")) === null ||
				_c === void 0
					? void 0
					: _c.value) || "";
			inputby =
				((_d = document.getElementById("legalInputBy")) === null ||
				_d === void 0
					? void 0
					: _d.value) || "";
			fid = "2";
			...
			reqby =
				((_e = document.getElementById("methRequestBy")) === null ||
				_e === void 0
					? void 0
					: _e.value) || "";
			inputby =
				((_f = document.getElementById("methInputBy")) === null ||
				_f === void 0
					? void 0
					: _f.value) || "";
			fid = "3";
	...
	// Event ปุ่มส่งฟอร์ม
	(_a = document.getElementById("sendFuncFormBtn")) === null || _a === void 0
		? void 0
		: _a.addEventListener("click", () => handleFormSubmit("functional"));
	(_b = document.getElementById("sendLegalFormBtn")) === null || _b === void 0
		? void 0
		: _b.addEventListener("click", () => handleFormSubmit("legal"));
	(_c = document.getElementById("sendMethFormBtn")) === null || _c === void 0
		? void 0
		: _c.addEventListener("click", () => handleFormSubmit("meth"));
	// Initial
	(0, formUtils_js_1.toggleSubmit)(trainingType, submitBtn);
	// ใช้งาน bindDynamicList ได้เหมือนเดิม
	(0, formUtils_js_1.bindDynamicList)(
		"funcObjectiveList",
		"funcObjective",
		"ระบุวัตถุประสงค์...",
		"objective"
