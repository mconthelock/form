          ...
          <td rowspan="${rspan}" class="align-top text-center p-4 border-r border-base-300">
            <div class="stat p-0">
              <div class="stat-value ${
					(system.unmatched || 0) > 0 ? "text-error" : ""
				} text-2xl">${system.unmatched || 0}</div>
              <div class="stat-desc font-bold ${
					(system.unmatched || 0) > 0 ? "text-error/60" : ""
				} uppercase">Users</div>
                ...
                <tr class="hover ${borderClass} transition-all duration-200">
                  ...
                  <td class="p-4 border-b border-base-200">
                    <div class="text-sm text-slate-700 leading-relaxed">
                      ${
							program.detail_remark ||
							"<span class='text-slate-400 italic'>No details provided</span>"
						}
                    </div>
                  </td>
                </tr>
